...
//                describe(`ES5疑似クラスインスタンスFunctionObject`, ()=>{
//                    function Es5Cls(){}
//                    test('new (function Es5Cls(){})',()=>expect(Tys.name(new Es5Cls())).toBe('FunctionObject'));
//                });
                ...
                describe(`匿名ES5疑似クラスインスタンス`, ()=>{//FunctionInstance
                    ...
                    // Expected: "ES5.Instance<MyEs5Cls>"
                    // Received: "PrototypedObject"
                    //test('new (function(){})',()=>expect(Tys.name(obj)).toBe('ES5.Instance<MyEs5Cls>'));
