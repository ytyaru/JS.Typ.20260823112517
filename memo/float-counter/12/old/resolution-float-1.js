...
//const rd = (self, n) => Math[n](self._.v * self._.scale) / self._.scale;
//function rd(n) {return Math[n](this._.v * this._.scale) / this._.scale};
function rd(self, n) {return Math[n](self._.v * self._.scale) / self._.scale};
class RoundFloat extends SafeFloat {
    static Method = Object.freeze({
        floor: (self) => rd(self, 'floor'), // floorの名前が重複しているのを解消できないか？
        trunc: (self) => rd(self, 'trunc'),
        ceil: (self) => rd(self, 'ceil'),
        round: (self) => rd(self, 'round'), // halfUp 四捨五入
//        floor: (self) => rd.bind(self, 'floor'),
//        trunc: (self) => rd.bind(self, 'trunc'),
//        ceil: (self) => rd.bind(self, 'ceil'),
//        round: (self) => rd.bind(self, 'round'), // halfUp 四捨五入
//        floor: (self) => rd(self, 'floor'),
//        trunc: (self) => rd(self, 'trunc'),
//        ceil: (self) => rd(self, 'ceil'),
//        round: (self) => rd(self, 'round'), // halfUp 四捨五入
//        floor: (self) => Math.floor(self._.v * self._.scale) / self._.scale,
//        trunc: (self) => Math.trunc(self._.v * self._.scale) / self._.scale,
//        ceil: (self) => Math.ceil(self._.v * self._.scale) / self._.scale,
//        round: (self) => Math.round(self._.v * self._.scale) / self._.scale, // halfUp 四捨五入
        even: (self) => { 
