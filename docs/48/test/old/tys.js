    ...
    describe(`name`, ()=>{
        describe(`正常系`, ()=>{
            ...
            describe(`Object系`, ()=>{
                ...
                test('NonePrototypeObject',()=>expect(Tys.name(Object.create(null))).toBe('NonePrototypeObject'));
...
//                        test('Value',()=>expect(Tys.name(v)).toBe('Descriptor.Data.Value'));
//                        test('Method',()=>expect(Tys.name(m)).toBe('Descriptor.Data.Method'));
//                        test('Getter',()=>expect(Tys.name(g)).toBe('Descriptor.Access.Get'));
//                        test('Setter',()=>expect(Tys.name(s)).toBe('Descriptor.Access.Set'));
//                        test('Accessor',()=>expect(Tys.name(a)).toBe('Descriptor.Access.GetSet'));
...
//                    test('MyClass',()=>expect(Tys.name(MyClass)).toBe('ES6.Class<MyClass>'));
                });
                describe(`匿名ES6クラス系`, ()=>{
                    test('class{}',()=>expect(Tys.name(class{})).toBe('Class<(Anonymous)>'));
//                    test('class{}',()=>expect(Tys.name(class{})).toBe('ES6.Class<(Anonymous)>'));
                });
                describe(`ES5疑似クラス系`, ()=>{
                    function MyEs5Cls(){}
