export class TextTree {
    ...
    static parse(text, indentMode = TextTree.Indent.infer) {
        ...
        const { unit, parsedLines } = this.#parseIndentation(rawLines, indentMode);
        const tokens = this.#tokenizeLines(parsedLines);
        return this.#buildHierarchy(tokens, unit);
    }
    ...
    static #parseIndentation(rawLines, indentMode) {
        ...
        return { unit: lockedUnit || "\t", parsedLines: parsed };
    }
    ...
    static #buildHierarchy(tokens, unit) {
        const root = {};
