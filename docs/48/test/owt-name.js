...
describe(`owT`, ()=>{
    ...
    describe(`Object系`, ()=>{
        ...
        describe(`Class系`, ()=>{
            test(`owT.o.cls(0)`, ()=>assertThrow(TypeError, `Expected: Class\nActual: ${tof(0)}`, ()=>owT.o.cls(0)));
            test(`owT.o.cls.es6(0)`, ()=>assertThrow(TypeError, `Expected: ES6.Class\nActual: ${tof(0)}`, ()=>owT.o.cls.es6(0)));
            test(`owT.o.cls.es5(0)`, ()=>assertThrow(TypeError, `Expected: ES5.Class\nActual: ${tof(0)}`, ()=>owT.o.cls.es5(0)));
            test(`owT.o.cls.native(0)`, ()=>assertThrow(TypeError, `Expected: NativeClass\nActual: ${tof(0)}`, ()=>owT.o.cls.native(0)));
            test(`owT.o.cls.es6(0,C)`, ()=>assertThrow(TypeError, `Expected: ES6.Class<C>\nActual: ${tof(0)}`, ()=>owT.o.cls.es6(0,C)));
            function MyFnCls(){}
            test(`owT.o.cls.es5(0,C)`, ()=>assertThrow(TypeError, `Expected: ES5.Class<MyFnCls>\nActual: ${tof(0)}`, ()=>owT.o.cls.es5(0,MyFnCls)));
            test(`owT.o.cls.native(0,C)`, ()=>assertThrow(TypeError, `Expected: NativeClass<Map>\nActual: ${tof(0)}`, ()=>owT.o.cls.native(0,Map)));
        });
        describe(`Function系`, ()=>{
            test(`owT.o.fn(0)`, ()=>assertThrow(TypeError, `Expected: Function\nActual: ${tof(0)}`, ()=>owT.o.fn(0)));
            test(`owT.o.fn.some(0)`, ()=>assertThrow(TypeError, `Expected: Function\nActual: ${tof(0)}`, ()=>owT.o.fn.some(0)));
            test(`owT.o.fn.bound(0)`, ()=>assertThrow(TypeError, `Expected: BoundFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.bound(0)));
            test(`owT.o.fn.native(0)`, ()=>assertThrow(TypeError, `Expected: NativeFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.native(0)));
            describe(`Arrow系`, ()=>{
                test(`owT.o.fn.arrow(0)`, ()=>assertThrow(TypeError, `Expected: ArrowFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.arrow(0)));
                test(`owT.o.fn.arrow.a(0)`, ()=>assertThrow(TypeError, `Expected: AsyncArrowFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.arrow.a(0)));
                test(`owT.o.fn.arrow.s(0)`, ()=>assertThrow(TypeError, `Expected: SyncArrowFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.arrow.s(0)));
            });
            test(`owT.o.fn.a(0)`, ()=>assertThrow(TypeError, `Expected: AsyncFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.a(0)));
            test(`owT.o.fn.g(0)`, ()=>assertThrow(TypeError, `Expected: GeneratorFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.g(0)));
            test(`owT.o.fn.ag(0)`, ()=>assertThrow(TypeError, `Expected: AsyncGeneratorFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.ag(0)));
            test(`owT.o.fn.ag(0)`, ()=>assertThrow(TypeError, `Expected: AsyncGeneratorFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.ag(0)));
            test(`owT.o.fn.s(0)`, ()=>assertThrow(TypeError, `Expected: SyncFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.s(0)));
            test(`owT.o.fn.anonymous(0)`, ()=>assertThrow(TypeError, `Expected: AnonymousFunction\nActual: ${tof(0)}`, ()=>owT.o.fn.anonymous(0)));
        });
        describe(`Method系`, ()=>{
            test(`owT.o.md(0)`, ()=>assertThrow(TypeError, `Expected: Method\nActual: ${tof(0)}`, ()=>owT.o.md(0)));
            test(`owT.o.md.some(0)`, ()=>assertThrow(TypeError, `Expected: Method\nActual: ${tof(0)}`, ()=>owT.o.md.some(0)));
