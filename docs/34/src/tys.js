...
export class Tys {// Type string name
    static name(v) {
        //['Null','Undefined','Array'].some()CORE
        ...
        return 'object'===to ? ObjTys.is(v,tag) : 'Number'===tag ? this._num(v, tag) : tag;
...
//        return name;
    ...
    static _tag(v) {return Object.prototype.toString.call(v).slice(8, -1);}
