    ...
    describe(`name`, ()=>{
        describe(`正常系`, ()=>{
            ...
            describe(`Object系`, ()=>{
                ...
                test('NonePrototypeObject',()=>expect(tof(Object.create(null))).toBe('NonePrototypeObject'));
...
//                        test('Value',()=>expect(tof(v)).toBe('Descriptor.Data.Value'));
//                        test('Method',()=>expect(tof(m)).toBe('Descriptor.Data.Method'));
//                        test('Getter',()=>expect(tof(g)).toBe('Descriptor.Access.Get'));
//                        test('Setter',()=>expect(tof(s)).toBe('Descriptor.Access.Set'));
//                        test('Accessor',()=>expect(tof(a)).toBe('Descriptor.Access.GetSet'));
...
//                    test('MyClass',()=>expect(tof(MyClass)).toBe('ES6.Class<MyClass>'));
                });
                describe(`匿名ES6クラス系`, ()=>{
                    test('class{}',()=>expect(tof(class{})).toBe('Class<(Anonymous)>'));
//                    test('class{}',()=>expect(tof(class{})).toBe('ES6.Class<(Anonymous)>'));
                });
                describe(`ES5疑似クラス系`, ()=>{
                    function MyEs5Cls(){}
