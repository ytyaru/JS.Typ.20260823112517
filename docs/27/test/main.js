...
describe(`isT`, ()=>{
    ...
    describe(`o`, ()=>{
        describe(`()`, ()=>{
            test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o()));
            describe(`false`, ()=>{
        ...
        describe(`cls`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.cls()));
                describe(`false`, ()=>{
        ...
        describe(`ins`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.ins()));
                describe(`false`, ()=>{
        ...
        describe(`des`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.des()));
                describe(`false`, ()=>{
            ...
            describe(`d`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.des.d()));
                    describe(`false`, ()=>{
                        describe(`Obj系`, ()=>{
            ...
            describe(`a`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.des.a()));
                    describe(`false`, ()=>{
                        describe(`Obj系`, ()=>{
                            const data = [[{}, {value:0}],[{}, {value(){}}]].map(x=>[getDes(...x)]);
                            test.each(data)(`(%p)`, (v)=>{
        ...
        describe(`fn`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.fn()));
                describe(`false`, ()=>{
            ...
            describe(`arrow`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.fn.arrow()));
                    describe(`false`, ()=>{
        ...
        describe(`md`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.o.md()));
                describe(`false`, ()=>{
    ...
    describe(`d`, ()=>{
        describe(`()`, ()=>{
            test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.d()));
            describe(`false`, ()=>{
        ...
        describe(`num`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.d.num()));
                describe(`false`, ()=>{
        ...
        describe(`obj`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new isT.d.obj()));
                describe(`false`, ()=>{
...
describe(`owT`, ()=>{
    ...
    describe(`o`, ()=>{
        describe(`()`, ()=>{
            test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o()));
            describe(`TypeError`, ()=>{
                test.each([...prims, ...dangers])(`(%p)`, (v)=>{
...
//                    assertThrow(TypeError, `Expected: a value that makes 'isT.o(v)' return true.\nActual: ${tof(v)}`, ()=>owT.o.some(v));
        ...
        describe(`cls`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.cls()));
                describe(`TypeError`, ()=>{
        ...
        describe(`ins`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.ins()));
                describe(`TypeError`, ()=>{
        ...
        describe(`des`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.des()));
                describe(`TypeError`, ()=>{
            ...
            describe(`d`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.des.d()));
                    describe(`TypeError`, ()=>{
                        describe(`Obj系`, ()=>{
                            const data = [[{_d:0}, {get(){return this._d}}], [{_d:0}, {set(v){this._d=v;}}], [{_d:0}, {get(){return this._d}, set(v){this._d=v}}]].map(x=>[getDes(...x)]);
                            test.each(data)(`(%p)`, (v)=>{
            ...
            describe(`a`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.des.a()));
                    describe(`TypeError`, ()=>{
                        describe(`Obj系`, ()=>{
                            const data = [[{}, {value:0}],[{}, {value(){}}]].map(x=>[getDes(...x)]);
                            test.each(data)(`(%p)`, (v)=>{
        ...
        describe(`fn`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.fn()));
                describe(`TypeError`, ()=>{
            ...
            describe(`arrow`, ()=>{
                describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.fn.arrow()));
                    describe(`TypeError`, ()=>{
        ...
        describe(`md`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new owT.o.md()));
                describe(`TypeError`, ()=>{
