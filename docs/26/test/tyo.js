...
describe(`Tyo`, ()=>{
    describe(`is`, ()=>{
        describe(`()`, ()=>{
            test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois()));
            describe(`false`, ()=>{
        ...
        describe(`cls`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.cls()));
                describe(`false`, ()=>{
        ...
        describe(`ins`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.ins()));
                describe(`false`, ()=>{
        ...
        describe(`des`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.des()));
                describe(`false`, ()=>{
            ...
            describe(`d`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.des.d()));
                    describe(`false`, ()=>{
                        describe(`Obj系`, ()=>{
            ...
            describe(`a`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.des.a()));
                    describe(`false`, ()=>{
                        describe(`Obj系`, ()=>{
                            const data = [[{}, {value:0}],[{}, {value(){}}]].map(x=>[getDes(...x)]);
                            test.each(data)(`(%p)`, (v)=>{
        ...
        describe(`fn`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.fn()));
                describe(`false`, ()=>{
            ...
            describe(`arrow`, ()=>{
                describe(`()`, ()=>{
                    test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.fn.arrow()));
                    describe(`false`, ()=>{
        ...
        describe(`md`, ()=>{
            describe(`()`, ()=>{
                test(`ReferenceError`, ()=>assertThrow(ReferenceError, `コンストラクタ生成禁止です。`, ()=>new Tyois.md()));
                describe(`false`, ()=>{
